            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.navBlock}>
                    <label className={styles.burger} htmlFor="burger">
                        <input className={styles.burger__input} type="checkbox" id="burger" />
                        <span className={styles.burger__stick}></span>
                        <span className={styles.burger__stick}></span>
                        <span className={styles.burger__stick}></span>
                    </label>
                </div>
                ...
                <div className={styles.navBlock}>
                    <button className={styles.enter_btn} style={{ fontFamily: "IBM Plex Mono", color: "#FF5550" }}>ВОЙТИ</button>
                </div>
